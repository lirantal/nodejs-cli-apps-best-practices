...
<p align="center">
  <h1 align="center">Лучшие практики написания CLI приложений на Node.js</h1>
Коллекция лучших, тщательно отобранных методов написания успешных CLI (Command Line Interface - Интерфейс командной строки) приложений, которые удобны и понятны пользователям.
</p>

### Для чего это руководство?

Плохое CLI-приложение может легко оттолкнуть пользователя от взаимодействия с ним. Построение успешных CLI-приложений требует внимания к деталям и к ощущениям пользователей для того, чтобы приложение было удобным в использовании. Очень легко сделать что-либо неправильно.

В этом руководстве я составил список лучших методов в различных областях, направленных на улучшение взаимодействий пользователей с CLI-приложениеми.

### Особенности:

- 37 лучших методов построения успешных CLI-приложений на Node.js
- ✅ Читайте на разных языках: [🇨🇳](./README_zh-Hans.md), [🇪🇸](./README_es.md), или [помогите перевести](https://crowdin.com/project/nodejs-cli-apps-best-practices) на другие языки. [Предложить новые языки](https://crowdin.com/project/nodejs-cli-apps-best-practices/discussions).
...
<a href="https://www.github.com/lirantal/nodejs-cli-apps-best-practices" target="_blank">
  <img src="https://badgen.net/badge/Node.js CLI Apps/Best Practices/purple" alt="Лучшие методы написания CLI приложений на Node.js"/>
</a>
...
Всем привет, я [Liran Tal](https://twitter.com/liran_tal) и я увлекаюсь написанием интерфейсов командной строки.

Некоторые мои недавние работы по написанию CLI-приложений на Node.js, включая следующие Open Source проекты (проекты с открытым исходным кодом):
...
<table>
  <tr>
     ...
     <td align="center">
      <a href="https://github.com/lirantal/lockfile-lint"><img src="https://repository-images.githubusercontent.com/189734318/d2d03200-5bfb-11ea-9eb6-70144dbe2197" width="150px;" alt="lockfile-lint - Lint an npm or yarn lockfile to analyze and detect security issues"/><br /><sub><b>lockfile-lint</b></sub></a><br/>Анализирует lockfile npm или yarn на наличие проблем с безопасностью
     </td>
     <td align="center">
      <a href="https://github.com/lirantal/is-website-vulnerable"><img src="https://repository-images.githubusercontent.com/212983914/2d33b500-e84d-11e9-820e-799f368c4c44" width="150px;" alt="is-website-vulnerable - finds publicly known security vulnerabilities in a website's frontend JavaScript libraries"/><br /><sub><b>is-website-vulnerable</b></sub></a><br/>находит публично известные проблемы с безопасностью сайта в его JavaScript библиотеках фронтенда
     </td>
  </tr>
</table>
<!-- markdownlint-enable -->
...
- 1 Опыт командной строки
  - 1.1 [Соблюдение POSIX аргументов](#11-respect-posix-args)
  - 1.2 [Создание понятных CLI](#12-build-empathic-clis)
  -
...
Unix-like operating systems popularized the use of the command line and tools such as `awk`, `sed`. Подобные утилиты эффективно стандартизировали поведение параметров (флагов) командной строки, опций-аргументов и других операндов.
