...
3. **I/O and interoperability** (§3.1, §3.2, §3.5, §3.6, §4.2): STDIN, structured output, gated interactivity, STDOUT/STDERR separation, graceful degradation
